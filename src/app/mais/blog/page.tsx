...
import { Search, Calendar, User, Clock, ArrowRight, Link, Play, Headphones, Star } from "lucide-react"
       ...
       <section className="relative py-20">
         ...
         <div className="relative z-10 container mx-auto px-4 text-center text-white">
           <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-32">Blog Viver Saudável</h1>
